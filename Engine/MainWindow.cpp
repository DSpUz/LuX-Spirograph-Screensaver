	...
	hInst( hInst )
{
	...
	GetDesktopResolution(horizontalRes, verticalRes);
	wr.left = 0;
	wr.right = horizontalRes;
	wr.top = 0;
	wr.bottom = verticalRes;
	AdjustWindowRect( &wr,WS_CAPTION | WS_MINIMIZEBOX | WS_SYSMENU,FALSE );
	hWnd = CreateWindow( wndClassName,L"Spirocrap LuX Screensaver Mod Remastered",
...
int MainWindow::GetHorizRes() const
{
	return horizontalRes;
}

int MainWindow::GetVertRes() const
{
	return verticalRes;
}
